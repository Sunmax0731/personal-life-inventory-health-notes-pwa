...
`D:\AI\WebApp\personal-life-inventory-health-notes-pwa`

## 事前準備

1. GitHub Release `v0.1.0-alpha.1` から `dist/personal-life-inventory-health-notes-pwa-docs.zip` を取得できることを確認する。
